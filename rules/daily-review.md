...
- **Skipped items do NOT auto-roll-forward.** They go back to the system queue (Linear or parked-tasks file) and re-compete for tomorrow's cap slots via the 9:00 consent gate. No silent backlog growth.
